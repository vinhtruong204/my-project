...
export class AutoBetContainer extends BetContainer {
    ...
    constructor(x: number, y: number) {
        ...
        this.autoBetButton.position.set(this.selectMines.width / 2, this.numberOfGames.y + this.numberOfGames.height + 4);
    ...
    private onValueChange(value: string) {
        this.inputNumberOfGames.value = Number(value) > MAX_NUMBER_OF_GAMES ? String(MAX_NUMBER_OF_GAMES) : String(value);
    }
}